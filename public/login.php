...
<body class="min-h-screen flex items-center justify-center bg-gray-900 text-white relative overflow-hidden">
  ...
  <div class="bg-gray-800 bg-opacity-80 p-8 rounded-xl shadow-2xl w-full max-w-md z-10">
    ...
    <p class="mt-4 text-center text-sm text-gray-300">
      New user? <a href="register.php" class="text-blue-400 hover:underline">Register here</a>
    </p>
  </div>
